...
get_ipython().system('ls ../input/radek-fast-ai-whale-full-stage1')


# In[ ]:


get_ipython().system('cp ../input/radek-fast-ai-whale-full-stage1/res50-full-train-stage-1.pth /kaggle/working')
