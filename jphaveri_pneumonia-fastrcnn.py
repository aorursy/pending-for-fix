...
inputdir = '/kaggle/input/rsna-pneumonia-detection-challenge/stage_2_train_images/'
...
train_path =  '/kaggle/working/annotation.txt' # Training data (annotation file)
