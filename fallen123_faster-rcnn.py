...
# b = train_df["bbox"].apply(lambda X: bbox(list(map(float,X[1:-1].split(', ')))))
...
data = pd.read_csv("../input/train-annotation/train-annotations-bbox.csv", sep=" ", header=None)
data.head()
...
import shutil
for i in range (0,5):
    src = '../input/voctrain/VOCdevkit/VOC2007/JPEGImages/'+str(os.listdir('../input/voctrain/VOCdevkit/VOC2007/JPEGImages/')[i])
    dst = '/kaggle/working/test_img/test_'+str(i)+'.jpg'
    d = shutil.copy(src,dst)
